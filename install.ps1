...
$pythonFiles = @('wqpu.py','wqpu_chain.py','wqpu_wallet.py','wqpu_session.py','wqpu_meter.py','wqpu_accounting.py','wqpu_attestation.py','wqpu_payments.py','wqpu_claim.py','wqpu_vouchers.py','wqpu_runtime.py','wqpu_autopay.py','wqpu_runtime_pin.py','wqpu_network_guard.py','wqpu_node_identity.py','wqpu_node_status.py','wqpu_public_security.py','wqpu_entry.py')
