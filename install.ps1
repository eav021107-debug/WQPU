...
$cacheBuster = 'runtime-pin-0.6.0-dev-r1'
...
$pythonFiles = @('wqpu.py','wqpu_chain.py','wqpu_wallet.py','wqpu_session.py','wqpu_meter.py','wqpu_payments.py','wqpu_claim.py','wqpu_vouchers.py','wqpu_runtime.py','wqpu_autopay.py','wqpu_runtime_pin.py','wqpu_entry.py')
